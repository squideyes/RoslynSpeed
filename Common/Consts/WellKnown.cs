...
namespace Common
{
    public static class WellKnown
    {
        ...
        static WellKnown()
        {
            Trails = new Dictionary<string, Trail>();

            Trails.Add("Default", 
                Trail.Load(Properties.Resources.Default));

            SourceCode = Properties.Resources.SourceCode;
        }

        public static string SourceCode { get; }
        public static Dictionary<string, Trail> Trails { get; }
    }
}
